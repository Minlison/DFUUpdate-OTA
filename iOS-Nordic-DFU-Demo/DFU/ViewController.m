...
//    NSString *UUID_DFUServices = @"00001530-1212-EFDE-1523-785FEABCD123"; // DFU 升级服务
//    NSString *UUID_DFUCharacteristics = @"00001531-1212-efde-1523-785feabcd123"; // DFU 升级特征值服务
    NSArray *scanForService = @[[CBUUID UUIDWithString:@"6E400001-B5A3-F393-E0A9-E50E24DCCA9E"]]; // 蓝牙设备连接服务
    NSArray *discoverServices = @[[CBUUID UUIDWithString:dfuServiceUUIDString]];
    NSArray *discoverCharacters = @[[CBUUID UUIDWithString:dfuControlPointCharacteristicUUIDString]];
    [baby setBabyOptionsWithScanForPeripheralsWithOptions:scanForPeripheralsWithOptions connectPeripheralWithOptions:nil scanForPeripheralsWithServices:scanForService discoverWithServices:discoverServices discoverWithCharacteristics:discoverCharacters];
}
